...
ppo_percentage_area_covered = ppo_results["ppo_percentage_area_covered"]
# Scale the values by 100
ppo_percentage_area_covered_scaled = [p * 100 for p in ppo_percentage_area_covered]
...
area_covered_path = os.path.join(plot_path, "ppo_percentage_area_covered.png")

# Plot
plot_percentage_area_covered(
    data=ppo_percentage_area_covered_scaled,
    ylabel="Percentage Area Covered",
    xlabel="Trial Number",
    fig_title="PPO Percentage Area Covered Per Trial",
